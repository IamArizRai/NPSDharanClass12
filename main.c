//
// Created by NPS class 12 computer group 2080
//
...
int main()
{
    ...
    title();
    printf("\n\n\t\t\tC programming project 2024");
    printf("\n\n\t\t\t\tThe NPS Class 12 Computer Science Team");
    printf("\n\n\t\t\t Nepal Police School Dharan-13,Sunsari\n\t\t\t");
    printChar('=',38);
